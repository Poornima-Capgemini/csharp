<%@ Page Title="" Language="C#" MasterPageFile="~/BMS.Master" AutoEventWireup="true" CodeBehind="UpdateBook.aspx.cs" Inherits="EmsWebApp.UpdateBook" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table align="center" cellpadding="6" cellspacing="6" style="width: 70%; border-style: solid; border-width: 4px; background-color: #0000FF">
        <tr>
            <td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Label ID="Label3" runat="server" BackColor="#FFFFCC" Text="Update Book Details"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
...
&nbsp;&nbsp;
        ...
        <tr>
            <td>
                <asp:Button ID="Button1" runat="server" BackColor="White" Text="Update Book" OnClick="Button1_Click" />
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
